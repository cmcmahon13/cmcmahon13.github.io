---
title: "Linked Fate Study 2b: Technical Appendix"
...
<p class="item-note">Participants rated items about perceived support and competition between Latina women and White women at work.</p>
<ul>
<li>White women really care about Latina women's well-being at work.</li>
<li>White women act competitively with Latina women in the workplace. <em>Reverse-coded</em></li>
<li>Latina women really care about White women's well-being at work.</li>
<li>Latina women act competitively with White women in the workplace. <em>Reverse-coded</em></li>
</ul>
</div>
...
<li>To what extent do people high in power and status feel sympathy toward Latina women at work?</li>
<li>To what extent do people high in power and status assist White women at work?</li>
<li>To what extent do people high in power and status defend Latina women at work?</li>
</ul>
</div>

<div class="item-card">
<h4>Linked fate</h4>
<p class="item-note">Participants rated perceived shared workplace outcomes between Latina women and White women.</p>
<ul>
...
<li>Workplace issues that affect White women also affect Latina women.</li>
<li>White women and Latina women have encountered similar discrimination in the past.</li>
</ul>
</div>
...
<tbody>
  <tr>
   <td> White women relational orientation toward Latina women </td>
   <td> 0.90 </td>
  </tr>
  <tr>
   <td> Latina women relational orientation toward White women </td>
   <td> 0.83 </td>
  </tr>
  <tr>
  ...
  <tr>
   <td> Pity elicitation of Latina women </td>
   <td> 0.72 </td>
  </tr>
  <tr>
  ...
  <tr>
   <td> Active facilitation of Latina women </td>
   <td> 0.97 </td>
  </tr>
  <tr>
   <td> Linked fate </td>
...
<caption>Scale correlations</caption>
 <thead>
  <tr>
   <th> Scale </th>
   <th> Linked fate </th>
   <th> White women relational orientation toward Latina women </th>
   <th> Latina women relational orientation toward White women </th>
   <th> Pity elicitation of White women </th>
   <th> Pity elicitation of Latina women </th>
   <th> Active facilitation of White women </th>
   <th> Active facilitation of Latina women </th>
...
These tests compare Latina women and White women on linked fate and the proposed mediators. The key descriptive pattern is whether the groups differ not only in linked fate, but also in perceptions of relational orientation and workplace treatment.
...
<tbody>
  <tr>
   <td> Linked fate </td>
   <td> Latina women − White women </td>
   <td> 4.12 </td>
   <td> 1.25 </td>
   <td> 4.52 </td>
   <td> 1.14 </td>
...
The mediation model tests whether the difference between Latina women and White women in linked fate is explained by perceived relational orientation, pity elicitation, and active facilitation. Participant race is coded 0 = White women and 1 = Latina women, so negative indirect effects indicate pathways that help explain lower linked fate among Latina women relative to White women.
...
data <- data %>%
  dplyr::mutate(
    race_proc = dplyr::case_when(
      ...
      race_name == "Latina women" ~ 1
    )
  )

mediator_vars <- c("supp_comp_wl", "supp_comp_lw", "emotion_ww", "emotion_lw", "behavior_ww", "behavior_lw")
mediator_labels <- c("supp_comp_wl" = "White women relational orientation toward Latina women", "supp_comp_lw" = "Latina women relational orientation toward White women", "emotion_ww" = "Pity elicitation of White women", "emotion_lw" = "Pity elicitation of Latina women", "behavior_ww" = "Active facilitation of White women", "behavior_lw" = "Active facilitation of Latina women")
...
The mediation tables summarize all paths in the parallel mediation model. The indirect-effect table is the primary result: indirect effects with confidence intervals that do not include zero indicate mediators that help explain the linked fate difference between Latina women and White women.
